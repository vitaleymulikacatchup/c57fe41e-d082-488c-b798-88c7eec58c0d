...
export const metadata: Metadata = {
  title: "Serenity Hotel - Luxury Hospitality Redefined",
  description: "Experience unparalleled luxury at Serenity Hotel. Elegant accommodations, world-class amenities, and exceptional service create unforgettable moments.",
  keywords: "luxury hotel, premium accommodation, spa wellness, fine dining, concierge service, business travel, vacation resort",
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "Serenity Hotel - Luxury Hospitality Redefined",
    description: "Experience unparalleled luxury at Serenity Hotel. Elegant accommodations, world-class amenities, and exceptional service.",
    siteName: "Serenity Hotel",
    type: "website",
    images: [
      {
        url: "https://images.pexels.com/photos/3635805/pexels-photo-3635805.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "Serenity Hotel luxury exterior",
      },
    ],
  },
  twitter: {
    ...
    title: "Serenity Hotel - Luxury Hospitality Redefined",
    description: "Experience unparalleled luxury at Serenity Hotel. Elegant accommodations, world-class amenities, and exceptional service.",
    images: ["https://images.pexels.com/photos/3635805/pexels-photo-3635805.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"],
  },
};
